...
public class BookController {
     ...
     */
    @Pager
    @PostMapping(value = "/queryViewer")
    public Result<List<BookVO>> queryViewer(@RequestBody BookQueryDto bookQueryDto) {
        return bookService.queryViewer(bookQueryDto);
    }
